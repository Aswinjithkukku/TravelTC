...
function NearbySection() {
  return (
    <div className='mx-5 my-10 lg:mx-auto lg:max-w-6xl'>
      <div className='text-xl font-semibold text-text mb-4'>Nearby destinations</div>
      ...
      <div className='border-2 rounded-lg mt-10 '>
        <div className='p-5 space-y-2'>
          ...
          <div className='text-sm text-text leading-relaxed'>Your Booking.com account lets you book using your saved details</div>
