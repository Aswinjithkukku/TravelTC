    ...
    <div className='bg-semisoft'>
        <div className='lg:max-w-screen-xl lg:mx-auto'>
            <div className='lg:flex space-x-10 py-20 lg:px-20 space-y-3'>
                ...
                <div className='lg:pl-36 lg:flex block'>
                    <div className=''>
                    ...
                    <button className='text-light font-medium bg-darktext px-3 py-2 rounded-md lg:py-4  mt-2 lg:mt-0 lg:rounded-r-xl'>SUBSCRIBE</button>
                    </div>
                </div>
            </div>
        </div>
