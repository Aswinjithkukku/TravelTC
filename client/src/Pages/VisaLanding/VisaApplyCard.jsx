...
function VisaApplyCard() {
    return (
        <div>
            <div className='border border-lightblue mx-6 rounded-2xl px-5 py-7 mt-5'>
                <div className=' rounded-2xl space-y-4 border border-text px-4 relative'>
                    ...
                    <div className='peer-checked:max-h-[100vh] max-h-0 transition-all duration-500 overflow-hidden'>
                        ...
                        <div className='space-y-2 w-full px-2'>
                            <div className='flex items-center space-x-2 text-lightblue'>
                                <span className='text-lg text-lightblue'><MdPeopleAlt /> </span>
                                <span className='text-lg'>Travellers</span>
                            </div>
                            <div className=''>
                                <select type='email' placeholder='Travellers' className='px-3 w-full border-none placeholder:text-text py-3 focus:outline-none focus:border-blue focus:ring-1 focus:ring-blue rounded-xl bg-light text-text' >
                                <option>choose one</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                        ...
                        <div className='flex justify-end px-2 py-2 text-lg text-lightblue'>AED 0.00</div>
                ...
                <div className=' rounded-2xl space-y-4 border border-text px-4 relative mt-5'>
